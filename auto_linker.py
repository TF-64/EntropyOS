...
base_command = f"i686-elf-gcc -T {path}/src/kernel/arch/linker.ld -o {path}/build/{argv[1]}.bin -ffreestanding -O2 -nostdlib `jemalloc-config --libdir`/libjemalloc.a -lstdc++ -lpthread "
